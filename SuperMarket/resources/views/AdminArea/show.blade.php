...
<div class="jumbotron">
  ...
  <h2 style="text-align: center; font-family: serif;font-size: 55px;">Dados do Cliente</h2>
...
<div class="input-group mb-3">
  ...
  <input value="{{$cliente->name}}" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled="true">
</div>
...
<div class="input-group mb-3">
  ...
  <input value="{{$cliente->email}}" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled="true">
</div>
...
<div class="input-group mb-3">
  ...
  <input value="{{$cliente->rua}}" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled="true">
  <div class="input-group-prepend">
    <span class="input-group-text">Bairro:</span>
  </div>
  <input value="{{$cliente->bairro}}" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled="true">
  <div class="input-group-prepend">
    <span class="input-group-text">Numero:</span>
  </div>
  <input value="{{$cliente->numero}}" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled="true">
  <div class="input-group-prepend">
    <span class="input-group-text">Cep:</span>
  </div>
  <input value="{{$cliente->cep}}" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" disabled="true">
</div>
